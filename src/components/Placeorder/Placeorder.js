        ...
        <div>
            ...
            <div className="container">
                <div className="row" style={{ marginTop: "10px" }}>
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        <div className="info p-3 w-75" style={{ backgroundColor: "lightgray", borderRadius: "30px" }}>
                            <img width="100px" src={deliverImg} alt="" />
                            <div className="div bg-light p-3 w-75 mb-3 rounded-3">
                            ...
                            <div className="div bg-light p-3 w-75 my-3 rounded-3 d-flex">
