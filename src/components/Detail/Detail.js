            ...
            <div className="container my-5">
                <div className="row d-flex align-items-center">
                    <div className="col-lg-6 col-md-6 col-sm-12">
                        ...
                        <h2>${detail?.price}</h2>
                        <button onClick={() => handleAddToCart(detail)} className="btn btn-danger btn-md">Add to Cart <i class="fas fa-cart-plus"></i></button>
                        <Link to="/">
                            <button className="btn btn-danger btn-md ms-4">Back</button>
                        </Link>
                        <div className="d-flex align-items-center mt-4">
                            <h4 className="me-4">Quantity:</h4>
                            <button onClick={handleDecrease} className="btn btn-lg me-3"><i class="fas fa-minus"></i></button>
                            <h5>{quantity}</h5>
                            <button onClick={handleIncrease} className="btn btn-lg ms-3"><i class="fas fa-plus"></i></button>
                        </div>
                    </div>
                    <div className="col-lg-6 col-md-6 col-sm-12">
